...
void main() {
    ...
    // Scale the input to noise (controls size of waves)
        float noiseScale = 10.0;

    // Strength of displacement
        float noiseAmount = 0.3;

    // Sample classic Perlin noise using position + time
        float n = cnoise(vec3(position.x * noiseScale, position.y * noiseScale, uTime * 0.2));

    // Apply noise to the Z component
        newPosition.z += n * noiseAmount;
